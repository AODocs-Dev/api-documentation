...
This is the custom system created by AODocs for the purposes of quick internal testing and similar use-cases behind your firewall. If you don't need access to Google Drive APIs, this is the quickest way to get started. Read more about how to [access APIs with AODocs security code](/docs/aodocs-staging.altirnao.com/1/c/Guides/Authentication/Access%20APIs%20with%20security%20codes).
...
Read more about how to [access AODocs APIs with access and ID tokens](/docs/aodocs-staging.altirnao.com/1/c/Guides/Authentication/Access%20APIs%20with%20Bearer%20tokens).
