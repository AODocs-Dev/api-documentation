...
> ⭑  **Note**: Requests for collections often return too many results and are best handled using [pagination](/docs/aodocs.altirnao.com/1/c/Guides/Best%20practices/Performance%20considerations).
...
[Resource: ApiDocument](/docs/aodocs.altirnao.com/1/types/ApiDocument) (an AODocs document)

[Collection: ApiLibraryList](/docs/aodocs.altirnao.com/1/types/ApiLibraryList) (a list of libraries)

[Resource: ApiDocumentType](/docs/aodocs.altirnao.com/1/types/ApiDocumentType) (the class/type of an AODocs document)