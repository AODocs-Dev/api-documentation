---
title: "Authentication use case examples/options/flows"
description: "To access AODocs APIs via OAuth 2.0, you need to provide an access token with each request. There are various flows to get an access token."
---
